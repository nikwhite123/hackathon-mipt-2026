      ...
      <RTCard>
        <Spin spinning={loading}>
          <Typography.Paragraph type="secondary" style={{ marginBottom: 12, fontSize: 12 }}>
            ...
            интенсивности атак по истории вашей организации (регион, сезон, час и при возможности — отрасль),
            критичности выбранного актива и внешнего доступа. По умолчанию используется эвристический прогноз.
            По кнопке ниже можно отдельно запросить ML-версию метода и цели атаки, не меняя risk score и окно атаки.
